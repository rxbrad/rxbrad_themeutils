...
sudo git clone --recursive --depth 1 "https://github.com/rxbrad/es-theme-freeplay.git" "/etc/emulationstation/themes/freeplay-blue"
sudo cp -r /etc/emulationstation/themes/freeplay-blue/blue.xml /etc/emulationstation/themes/freeplay-blue/color.xml
